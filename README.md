...
- Desktop conversions now expose Pause, Resume, and Cancel controls in the main action area: the Start button changes to Pause while running and Resume while paused, with Cancel shown directly below it.
